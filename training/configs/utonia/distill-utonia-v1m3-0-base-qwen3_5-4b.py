...
#   /group-volume/chaewon.yun/dataset/data/{scannet, nuscenes, waymo, ...}
# so every `data_root` resolves to ${DATASET_ROOT}/data/<dataset>.
    ...
    train=dict(
        ...
        datasets=[
            ...
            dict(
                ...
                crop_w=crop_w,
                patch_size=patch_size,
                data_root=f"{DATASET_ROOT}/data/hk_3d_maps_N",
            ...
            dict(
                ...
                data_root=f"{DATASET_ROOT}/data/nuscenes",
            ...
            dict(
                ...
                patch_size=patch_size,
                split=["train", "val", "test"],
                data_root=f"{DATASET_ROOT}/data/semantic_kitti",
                transform=outdoor_transform,
                test_mode=False,
                loop=1,
            ),
            ...
            dict(
                ...
                data_root=f"{DATASET_ROOT}/data/waymo",
                transform=outdoor_transform,
                test_mode=False,
                loop=1,
            ),
            ...
            dict(
                ...
                patch_size=patch_size,
                split=["train"],
                data_root=f"{DATASET_ROOT}/data/cap3d",
            ...
            dict(
                ...
                patch_size=patch_size,
                split=["train"],
                data_root=f"{DATASET_ROOT}/data/partnet_data_v0",
                transform=obj_transform,
                test_mode=False,
                loop=1,
            ),
            ...
            dict(
                ...
                patch_size=patch_size,
                split=["train", "val", "test"],
                data_root=f"{DATASET_ROOT}/data/graspnet",
            ...
            dict(
                ...
                patch_size=patch_size,
                split=["train"],
                data_root=f"{DATASET_ROOT}/data/scanobjectnn_raw",
            ...
            dict(
                ...
                patch_size=patch_size,
                split=["train", "test"],
                data_root=f"{DATASET_ROOT}/data/re10k_align",
                transform=indoor_transform,
                test_mode=False,
                loop=1,
            ),
